            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <script src="https://js.stripe.com/v3/"></script>
                        ...
                        <form action="/stripe" method="post" id="payment-form"> <?php echo e(csrf_field()); ?>

                        <div class="form-row">
                            <b>Total Amount To Be Paid</b>
                            <input readonly name="total_amount" value="<?php echo e(Session::get('grand_total')); ?>" class="form-control">
                            <b>Your Name</b>
...
?>
<?php echo $__env->make('wayshop.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\Way-Shop\resources\views/wayshop/orders/stripe.blade.php ENDPATH**/ ?>